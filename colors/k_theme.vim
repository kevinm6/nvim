...
" Section: Status Line
	hi StatusLine guifg=#606060 guibg=#303030 ctermbg=236 ctermfg=246
	hi StatusLineNC guifg=#A9A9A9 guibg=#606060 ctermfg=7 ctermbg=244
	if !has('nvim')
		hi StatusLineTerm guifg=#606060 guibg=#303030 ctermbg=234 ctermfg=246
