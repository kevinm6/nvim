   ...
   },
   {
      ...
      callback = function()
         vim.api.nvim_eval_statusline(
            "%!v:lua.require'core.statusline'.set_statusline()",
            {}
         )
...
---Create NewFile
user_command("NewFile", function(args) require("user_lib.functions").new_file(args) end, {
...
---Create NewTempFile
user_command("NewTempFile", function(args) require("user_lib.functions").new_tmp_file(args) end, {
