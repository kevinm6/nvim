...
local M = {
   ...
   keys = {
      ...
      },
      {
         "<leader>fO",
         function()
            require("util.functions").software_licenses().licenses()
         end,
...

      {
         "<leader>fb",
         function()
            require("telescope").extensions.file_browser.file_browser { cwd = vim.fn.getcwd() }
         end,
      ...
      },
      {
         "<leader>fs",
         function()
            require("telescope.builtin").grep_string { theme = "dropdown", previewer = false }
         end,
